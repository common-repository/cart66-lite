...
* NEW: Enhanced CSS
* NEW: Color picker for cart66 pages
* UPDATED: Fixed issue caused by inserting NULL values into columns set to NOT NULL
* UPDATED: Fixed status filtering caused by case mismatch
* UPDATED: Updated menu icons
* UPDATED: Include explicit tax and freight fields in authnet transactions

= 1.5.7 =

* UPDATED: WordPress 4.4 updates
* UPDATED: Optimize email log to prevent timeouts
* UPDATED: Updated country code list
